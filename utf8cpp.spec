...
Version  : 3.1
Release  : 1
URL      : https://github.com/nemtrif/utfcpp/archive/v3.1/utf8cpp-3.1.tar.gz
Source0  : https://github.com/nemtrif/utfcpp/archive/v3.1/utf8cpp-3.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572367997
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/utfcpp-3.1/LICENSE %{buildroot}/usr/share/package-licenses/utf8cpp/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
pushd clr-build
%make_install
popd
