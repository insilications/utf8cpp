...
Version  : 3.1.2
Release  : 2
URL      : https://github.com/nemtrif/utfcpp/archive/v3.1.2/utfcpp-3.1.2.tar.gz
Source0  : https://github.com/nemtrif/utfcpp/archive/v3.1.2/utfcpp-3.1.2.tar.gz
...
%prep
%setup -q -n utfcpp-3.1.2
cd %{_builddir}/utfcpp-3.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604945397
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/utfcpp-3.1.2/LICENSE %{buildroot}/usr/share/package-licenses/utf8cpp/3cba29011be2b9d59f6204d6fa0a386b1b2dbd90
pushd clr-build
%make_install
popd
